...
public class ObjectHandler implements IObjectHandler {
    ...
    public ObjectHandler(IObjectServicePort objectServicePort, IObjectRequestMapper objectRequestMapper, IObjectResponseMapper objectResponseMapper) {
        this.objectServicePort = objectServicePort;
        this.objectRequestMapper = objectRequestMapper;
        this.objectResponseMapper = objectResponseMapper;
    }
